...
<![endif]-->
<style type="text/css">
    .input-focus {border-color:#4798e8;}
</style>
<script type="text/javascript">
    function send_feedback(){
        ...
        $.ajax({
            url : "mail_intigration.php",
            type :"POST",
            dataType: 'json',
            data :{"std_name":std_name,"mail":mail,"mob_num":mob_num,"feedback":feedback,},
            success:function(e){
...
<body>
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- <span style="color: white;">Raghu Engineering College</span> -->
                        </b>
                        ...
                        <span class="logo-text">
                            ...
                            <img src="../../assets/images/logo1.png" class="light-logo" alt="homepage" /> -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic">
                                    <img src="assets/images/bot.jpg" alt="users" class="rounded-circle img-fluid" />
                                </div>
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium">RBOT</h5>
                                </div>
                            </div>
                            <!-- End User Profile-->
                        </li>
                        ...
                        <li class="sidebar-item">
                            <!-- <li class="sidebar-item">
                                <a href="feedback_admin.php" class="sidebar-link">
                                    ...
                                    <span class="hide-menu">  Feed Back to Admin </span>
                                </a>
                            </li> -->
                        ...
                        <!-- <li class="sidebar-item">
                            <a href="https://www.google.com/search?sxsrf=ALeKk026UhkwbARmtwZv8B5YSATBBB8OZA%3A1583579133930&source=hp&ei=_X9jXtPhNovRrQHN8qC4BA&q=google.com&oq=google.com&gs_l=psy-ab.3..0i131l3j0l4j0i131j0j0i131.4894.9094..9479...4.0..0.107.1063.9j2......0....1..gws-wiz.....10..35i362i39j35i39j35i305i39j0i10.sYKqeme9NDY&ved=0ahUKEwiT1P_9m4joAhWLaCsKHU05CEcQ4dUDCAY&uact=5" class="sidebar-link">
                                <i class="icon-Car-Wheel"></i>
                                <span class="hide-menu"> HELP </span>
                            </a>
                        </li> -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Enter Your Details</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <input class='form-control col-4 input-focus' placeholder="Enter Name" type="text" name="std_name" id="std_name" value=""><br>
                                    <h4 class="card-title">Email :</h4>
                                    <input class='form-control col-4 input-focus' placeholder="Enter Email" type="email" name="mail" id="mail" value=""><br>
                                    <h4 class="card-title">Mobile Number :</h4>
                                    <input class='form-control col-4 input-focus' placeholder="Enter Name" type="text" name="mob_num" id="mob_num" value=""><br>
                                    <h4 class="card-title">Feed Back:</h4>
                                    <textarea class='form-control col-4 input-focus' placeholder="Enter Your Feed Back" type="text" name="feedback" id="feedback"></textarea><br>
                                    <div class="col-4">
                                        <center>
                                            <button onclick="return send_feedback()" class='btn btn-info btn-rounded' type="submit" name="save" id="save">SAVE</button>
                                        </center>
                                    </div>
                                </form>
                            </div>
       ...
       All Rights Reserved by NSRIT Students. Designed and Developed by  Batch 14
</footer>
