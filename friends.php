...
<!-- Mirrored from themedesigner.in/demo/adminbite/html/ltr/ui-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Feb 2020 05:06:25 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>SCMS admin Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="friends.php">
                        <!-- Logo icon -->
                        <b class="logo-icon">
        ...
        <aside class="left-sidebar">
            ...
            <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../../database/logout.php" aria-expanded="false">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                   Powered by <a href="https://wrappixel.com/">Vulcantechs</a>.
            </footer>
        </div>
    </div>
